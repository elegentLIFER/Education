...
public class RvQuestionLibItemItemAdapter extends RecyclerView.Adapter<RvQuestionLibItemItemAdapter.RvThisViewHolder> {
    ...
    public RvQuestionLibItemItemAdapter(Context context, String paperTypeName, List<PaperListResponse.CourseClasslistBean.PaperTypeListBean.PaperListBean> beanList) {
    ...
    public void onBindViewHolder(@NonNull RvThisViewHolder holder, final int position) {
        final PaperListResponse.CourseClasslistBean.PaperTypeListBean.PaperListBean listBean = beanList.get(position);
        holder.tvPaperTypeName.setText(NUtil.getString(R.string.paper_name, paperTypeName, listBean.getPaperListName()));
        holder.tvNum.setText(listBean.getPaperSize());
        holder.llOuter.setOnClickListener(view -> {
            Intent intent = new Intent(context, PaperListActivity.class);
            intent.putExtra(PaperListActivity.PAPER_LIST_NAME, listBean.getPaperListName());
            intent.putExtra(PaperListActivity.PAPER_LIST_ID, listBean.getPaperListId());
