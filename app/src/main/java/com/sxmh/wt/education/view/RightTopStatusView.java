...
public class RightTopStatusView extends FrameLayout {
    ...
    public RightTopStatusView(@NonNull Context context) {
        super(context);
        initWork();
    }

    public RightTopStatusView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initWork();
        getAttr(context, attrs);
    }

    public RightTopStatusView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initWork() {
        View inflate = LayoutInflater.from(getContext()).inflate(R.layout.view_right_top_status, null);
