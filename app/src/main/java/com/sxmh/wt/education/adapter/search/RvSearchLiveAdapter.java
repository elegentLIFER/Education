...
public class RvSearchLiveAdapter extends RecyclerView.Adapter<RvSearchLiveAdapter.CollectionLiveViewHolder> {
    private Context context;
    private OnItemClickListener itemClickListener;
    private List<SearchResponse.LiveRoomListBean> liveRoomListBeanList;


    public RvSearchLiveAdapter(Context context, List<SearchResponse.LiveRoomListBean> liveRoomListBeanList) {
    ...
    public void onBindViewHolder(@NonNull CollectionLiveViewHolder holder, int position) {
        SearchResponse.LiveRoomListBean bean = liveRoomListBeanList.get(position);
