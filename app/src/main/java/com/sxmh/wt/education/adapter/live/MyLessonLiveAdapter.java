...
public class MyLessonLiveAdapter extends RecyclerView.Adapter<MyLessonLiveAdapter.LessonLiveViewHolder> {
    private Context context;
    private List<MyCourseClassifyResponse.CourseClassListBean.NetCourseListBean> beanList;
    private OnItemClickListener listener;

    public MyLessonLiveAdapter(Context context, List<MyCourseClassifyResponse.CourseClassListBean.NetCourseListBean> beanList) {
    ...
    public void onBindViewHolder(@NonNull LessonLiveViewHolder holder, final int position) {
        MyCourseClassifyResponse.CourseClassListBean.NetCourseListBean bean = beanList.get(position);
