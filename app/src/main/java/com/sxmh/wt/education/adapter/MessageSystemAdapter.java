...
public class MessageSystemAdapter extends RecyclerView.Adapter<MessageSystemAdapter.QuestionAskViewHolder> {
    ...
    public void onBindViewHolder(@NonNull QuestionAskViewHolder holder, int position) {
        holder.llOuter.setOnClickListener(view -> itemClickListener.onItemClick());
    }
